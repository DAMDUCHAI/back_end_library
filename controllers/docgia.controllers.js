    ...
    try {
      if (name) {
        const [results] = await sequelize.query(
          ` select tbdocgia.*, tbthongtinchungs.Ten,tbthongtinchungs.NgaySinh,tbthongtinchungs.MaGioiTinh,tbthongtinchungs.CCCD,tbthongtinchungs.Phone,tbthongtinchungs.DiaChi,tbgioitinhs.NoiDung as GioiTinh,tbthongtinchungs.img,tbacounts.Email,tbacounts.PassWord,tbacounts.Role,tbthethuviens.MaSinhVien,tbthethuviens.NgayCap,tbthethuviens.HSD  from tbdocgia left join tbthongtinchungs on tbdocgia.MaThongTinChung=tbthongtinchungs.id inner join tbacounts 
